...
Hi, I'm Zayden and I have been building Android apps for 8 years. In that time, I've learned that the best part of software engineering isn't writing code — it's making developers' lives better. Developer experience, build optimization, those feedback loops that mean the difference between flow state and frustration. That's what gets me excited.
